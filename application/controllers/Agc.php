...
class Agc extends CI_Controller {
	...
	public function oxen99(){
		...
		// 	echo "counter ke " . $i . "<br>";
		// 	echo $hasil[$i]["judul"] . "<br>";
		// 	echo $hasil[$i]["konten"] . "<br><br>";
		// }
