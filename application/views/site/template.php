...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html">actual<span>biz</span></a> <small>Simple design templates</small></h1>
      </div>
      <div class="clr"></div>
      <div class="menu_nav">
        <ul>
  ...
  <div class="content">
	<div class="content_resize">
	 <img src="<?php echo base_url('assets/images/hbg_img.jpg') ;?>" width="956" height="273" alt="" class="hbg_img" />
      <div class="clr"></div>
      <div class="mainbar">
        <div class="article">
          <h2><span>Template</span> License</h2>
          <div class="clr"></div>
          <p class="infopost">Posted <span class="date">on 11 sep 2018</span> by <a href="#">Owner</a> &nbsp;|&nbsp; Filed under <a href="#">templates</a>, <a href="#">internet</a> <a href="#" class="com">Comments <span>11</span></a></p>
          <img src="<?php echo base_url('assets/images/img1.jpg') ;?>" width="201" height="146" alt="" class="fl" />
        ...
        <div class="article">
          ...
          <div class="clr"></div>
          <p class="infopost">Posted <span class="date">on 29 aug 2010</span> by <a href="#">Owner</a> &nbsp;|&nbsp; Filed under <a href="#">templates</a>, <a href="#">internet</a> <a href="#" class="com">Comments <span>7</span></a></p>
          <img src="<?php echo base_url('assets/images/img2.jpg') ;?>" width="201" height="146" alt="" class="fl" />
  ...
  <div class="fbg">
    <div class="fbg_resize">
      <div class="col c1">
        ...
        <a href="#"><img src="<?php echo base_url('assets/images/pix1.jpg') ;?>" width="58" height="58" alt="" /></a> <a href="#"><img src="<?php echo base_url('assets/images/pix2.jpg') ;?>" width="58" height="58" alt="" /></a> <a href="#"><img src="<?php echo base_url('assets/images/pix3.jpg') ;?>" width="58" height="58" alt="" /></a> <a href="#"><img src="<?php echo base_url('assets/images/pix4.jpg') ;?>" width="58" height="58" alt="" /></a> <a href="#"><img src="<?php echo base_url('assets/images/pix5.jpg') ;?>" width="58" height="58" alt="" /></a> <a href="#"><img src="<?php echo base_url('assets/images/pix6.jpg') ;?>" width="58" height="58" alt="" /></a> </div>
      <div class="col c2">
