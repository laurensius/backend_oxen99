            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">
                        <h1><!--img src="images/logo.png" alt="logo"--><?php echo $config[0]->site_title; ?></h1>
                    </a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="<?php echo site_url('terms-and-condition.html');?>">Terms and Conditions</a></li>
        ...
        <div class="vertical-center sun">
             <div class="container">
                <div class="row">
                    <div class="action">
                        <div class="col-sm-12">
                            <h1 class="title"><?php echo $config[0]->site_title; ?></h1>
                            <p><?php echo $config[0]->site_tagline; ?></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9 col-sm-7">
                    <div class="row">
                    <?php for($x=0;$x<sizeof($latest_post);$x++){ ?>
                         <div class="col-md-6 col-sm-12 blog-padding-right">
                            <div class="single-blog two-column">
                                ...
                                <div class="post-content overflow">
                                    ...
                                    <p>
                                    <?php
                                        if(strlen($latest_post[$x]->post_content) > 100 ){
                                            $str_content = str_split($latest_post[$x]->post_content,100);
                                            echo $str_content;
                                        }else{
                                            echo $latest_post[$x]->post_content;
                                        } 
                                    ?>
                                    </p>
                                    <a href="<?php echo site_url('result/' . $latest_post[$x]->post_slug ); ?>" class="read-more">View More</a>
