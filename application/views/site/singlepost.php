...
<div class="main">
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="<?php echo site_url('terms-and-conditions.html');?>"><span>Terms and Conditions</span></a></li>
  ...
  <div class="footer">
    <div class="footer_resize">
      <p class="lf">Copyright &copy; <a href="<?php echo site_url(); ?>"><?php echo site_url(); ?></a>. All Rights Reserved</p>
